...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>twitch.user.id</code>.
     */
     ...
     */
    public final TableField<UserRecord, String> LOGIN = createField(DSL.name("login"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>twitch.user.display_name</code>.
     */
    ...
    /**
     * The column <code>twitch.user.type</code>.
     */
    public final TableField<UserRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>twitch.user.broadcaster_type</code>.
     */
    public final TableField<UserRecord, String> BROADCASTER_TYPE = createField(DSL.name("broadcaster_type"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>twitch.user.description</code>.
     */
    public final TableField<UserRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>twitch.user.profile_image_url</code>.
     */
    public final TableField<UserRecord, String> PROFILE_IMAGE_URL = createField(DSL.name("profile_image_url"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>twitch.user.offline_image_url</code>.
     */
    public final TableField<UserRecord, String> OFFLINE_IMAGE_URL = createField(DSL.name("offline_image_url"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>twitch.user.view_count</code>.
     */
    public final TableField<UserRecord, Integer> VIEW_COUNT = createField(DSL.name("view_count"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>twitch.user.created_at</code>.
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>twitch.session</code>
     * table
     */
